...
- Получение адреса по точке на карте (reverse geocoding);
- Сохранение выбранных адресов в локальное хранилище (Hive);
- Кеширование результатов геокодирования по координатам (Hive);
- Построение маршрута из выбранной точки или сохраненного адреса;
- Поддержка UI/UX iOS и Android.
