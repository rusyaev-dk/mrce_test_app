...
class _$AddressDtoImpl implements _AddressDto {
  ...
  @override
  String toString() {
    return 'AddressDto(id: $id, name: $name, address: $address, point: $point, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, address, point, createdAt);
...
abstract class _AddressDto implements AddressDto {
  const factory _AddressDto(
      ...
      required final MapPointDto point,
      required final DateTime createdAt}) = _$AddressDtoImpl;
